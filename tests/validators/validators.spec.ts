...
describe('RequiredValidator', () => {
  ...
  it('should return validation error if value is null', () => {
    ...
    const result = new RequiredValidator()
...
describe('StringLengthValidator', () => {
  ...
  it('should return validation error if value length is lower than minLength', () => {
    ...
    const result = new StringLengthValidator(4)
      .validate('123', 'property');
    expect(result)
      .toEqual({
  ...
  it('should return validation error if value length is greater than maxLength', () => {
    ...
    const result = new StringLengthValidator(undefined, 2)
      .validate('123', 'property');
    expect(result)
      .toEqual({
  ...
  it('should return undefined if value equals minLength', () => {
    ...
    const result = new StringLengthValidator(2, undefined)
      .validate('12', 'property');
    expect(result)
      .toBeUndefined();
  ...
  it('should return undefined if value equals minLength and maxLength', () => {
    ...
    const result = new StringLengthValidator(2, 2)
      .validate('12', 'property');
    expect(result)
      .toBeUndefined();
  ...
  it('should return undefined if value is not string', () => {
    ...
    const result = new StringLengthValidator(2, 4)
      .validate({}, 'property');
    expect(result)
      .toBeUndefined();
...
describe('StringRegexpValidator', () => {
  ...
  it('should return validation error if value doesn\'t match regexp', () => {
    ...
    const result = new StringRegexpValidator(/\d{1,10}/)
      .validate('John', 'property');
    expect(result)
      .toEqual({
  ...
  it('should return undefined if value is match regexp', () => {
    ...
    const result = new StringRegexpValidator(/\w{1,10}/)
      .validate('John', 'property');
    expect(result)
      .toBeUndefined();
...
describe('NumberValueValidator', () => {
  ...
  it('should return validation error if value is lower than min', () => {
    ...
    const result = new NumberValueValidator(10)
      .validate(9, 'property');
    expect(result)
      .toEqual({
  ...
  it('should return validation error if value is greater than max', () => {
    ...
    const result = new NumberValueValidator(undefined, 10)
      .validate(11, 'property');
    expect(result)
      .toEqual({
  ...
  it('should return undefined if value is between borders', () => {
    ...
    const result = new NumberValueValidator(0, 10)
      .validate(5, 'property');
    expect(result)
      .toBeUndefined();
  ...
  it('should return undefined if value equals min', () => {
    ...
    const result = new NumberValueValidator(5, undefined)
      .validate(5, 'property');
    expect(result)
      .toBeUndefined();
  ...
  it('should return undefined if value equals max', () => {
    ...
    const result = new NumberValueValidator(undefined, 5)
      .validate(5, 'property');
    expect(result)
      .toBeUndefined();
  ...
  it('should return undefined if value equals min and max', () => {
    ...
    const result = new NumberValueValidator(5, 5)
      .validate(5, 'property');
    expect(result)
      .toBeUndefined();
...
describe('TypeValidator', () => {
  ...
  describe('String type', () => {
    ...
    it('should return validation error if value is not string', () => {
      ...
      const result = (new (TypeValidator.String()))
        .validate(123, 'test');
      expect(result)
        .toEqual({
  ...
  describe('Number type', () => {
    ...
    it('should return validation error if value is not number', () => {
      ...
      const result = (new (TypeValidator.Number()))
        .validate('123', 'test');
      expect(result)
        .toEqual({
  ...
  describe('Boolean type', () => {
    ...
    it('should return validation error if value is not boolean', () => {
      ...
      const result = (new (TypeValidator.Boolean()))
        .validate('123', 'test');
      expect(result)
        .toEqual({
  ...
  describe('Object type', () => {
    ...
    it('should return validation error if value is not object', () => {
      ...
      const result = (new (TypeValidator.Object()))
        .validate('123', 'test');
      expect(result)
        .toEqual({
