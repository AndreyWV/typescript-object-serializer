...
describe('validate', () => {
  ...
  describe('basic validation', () => {
    ...
    it('should return validation error instance', () => {
      ...
      expect(validationResult[0])
        .toBeInstanceOf(CustomValidationError);
  ...
  describe('multiple validators', () => {
    ...
    class Test {
      ...
      @propertyValidators([
        ...
        CustomStringLengthValidator.with(3, 5),
      ])
      public declare property: string;
  ...
  it('should validate by all validators of current class and all it\'s parent', () => {
    ...
    class Test3 extends Test2 {
      ...
      @propertyValidators([
        StringRegexpValidator.with(/\w{3}/),
      ])
      public declare property: string;
