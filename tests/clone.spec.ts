...
describe('Clone', () => {
  ...
  describe('descendant of SerializableObject', () => {
    ...
    it('should return new class instance with same values', () => {
      ...
      expect(instance2.arrayOfStrings.length).toBe(2);
      expect(instance2.arrayOfStrings[0]).toBe('value-1');
      expect(instance2.arrayOfStrings[1]).toBe('value-2');
      expect(instance2.arrayOfNumbers.length).toBe(2);
      expect(instance2.arrayOfNumbers[0]).toBe(3);
      expect(instance2.arrayOfNumbers[1]).toBe(4);
      expect(instance2.arrayOfBooleans.length).toBe(2);
      expect(instance2.arrayOfBooleans[0]).toBe(false);
      expect(instance2.arrayOfBooleans[1]).toBe(true);

      expect(instance2.arrayOfAny.length).toBe(8);
      expect(instance2.arrayOfAny[0]).toBe(false);
      expect(instance2.arrayOfAny[1]).toBe(true);
      expect(instance2.arrayOfAny[2]).toBe(3);
      expect(instance2.arrayOfAny[3]).toBe(5);
      expect(instance2.arrayOfAny[4]).toBe('string');
      expect(instance2.arrayOfAny[5]).toEqual({ key: 'value' });
      expect(instance2.arrayOfAny[5]).toBe(instance1.arrayOfAny[5]);
      expect(instance2.arrayOfAny[6]).toBeInstanceOf(Property);
      expect(instance2.arrayOfAny[6].deepProperty).toBe('test');
      expect(instance2.arrayOfAny[6]).not.toBe(instance1.arrayOfAny[6]);
      expect(instance2.arrayOfAny[7]).toBe(null);
